...
int realEvaluateSquare(int pos[10]){
    int evaluation = 0;
    float points[10] = {0.2, 0.17, 0.2, 0.17, 0.22, 0.17, 0.2, 0.17, 0.2};
...
int evaluateGame(int position[10][10], int currentBoard) {
    int evale = 0;
    int mainBd[10] = {0};
    float evaluatorMul[10] = {1.4, 1, 1.4, 1, 1.75, 1, 1.4, 1, 1.4};
...
pair<int,int> miniMax(int position[10][10], int boardToPlayOn,int depth,int alpha,int beta,int maximizingPlayer){
    RUNS++;
